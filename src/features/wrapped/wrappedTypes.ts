...
export type WrappedSummary = { signalsThisWeek: number; confirmedSignals: number; accuracy: number; earlySignals: number; weekStreak: number; xp: number; nextLevelXp: number; xpToNextLevel: number };
...
export type WrappedReport = { period: WrappedPeriod; identity: WrappedIdentity; summary: WrappedSummary; mainTheme: WrappedTheme; topThemes: WrappedTheme[]; activity: WrappedActivityPoint[]; rightSignals: WrappedRightSignal[]; progress: WrappedProgress; explain: string[]; isEmpty?: boolean };
