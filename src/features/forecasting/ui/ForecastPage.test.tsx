...
describe('ForecastPage discoverability',()=>{
 it('renders at the production /forecast route',()=>{media(false);render(<MemoryRouter initialEntries={['/forecast']}><App/></MemoryRouter>);expect(screen.getByRole('heading',{level:1,name:'Сформулируйте проверяемый прогноз'})).toBeInTheDocument();});
