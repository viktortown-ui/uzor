    ...
    <ProductShell className="future-shell">
      <div className="future-page">
        ...
        >
          ...
          <p>
            Здесь отвечают на вопрос: «Стоит ли редакции подготовить этот вопрос?» Это advisory-сигнал для редакции, а не прогноз, официальный опрос или голосование за будущий исход.
          </p>
          {!isProductionConfigured && !forecastVisualFixturesActive ? (
