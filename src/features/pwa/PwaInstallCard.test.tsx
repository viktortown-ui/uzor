...
describe('PwaInstallCard', () => {
  ...
  it('marks focused Delta workspaces for collision-free launcher placement', async () => { const view=renderApp('/map'); emitPrompt(); expect(await screen.findByLabelText('Установка приложения')).toHaveClass('pwa-install-launcher--map'); view.unmount(); });
