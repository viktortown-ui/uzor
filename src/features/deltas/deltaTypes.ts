...
export type DeltaApiErrorCode = 'not_authenticated' | 'not_circle_member' | 'city_not_found' | 'category_not_found' | 'invalid_coordinates' | 'outside_city_area' | 'invalid_delta_payload' | 'delta_not_found' | 'author_reaction_locked' | 'unknown';
