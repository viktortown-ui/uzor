...
export function createEmptyDeltaDraft(): DeltaCreateDraft { return { currentStep: 1, districtCode: '', districtLabel: '', locationHint: '', direction: '', categorySlug: '', changeType: '', subject: '', statement: '', statementMode: 'auto', observedWindow: '', impactLevel: '', details: '' }; }
